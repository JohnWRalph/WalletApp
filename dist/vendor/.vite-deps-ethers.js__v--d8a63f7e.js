import {
  ...
  utils,
  wrapConstructor
} from "/vendor/.vite-deps-chunk-737QHDNX.js__v--d8a63f7e.js";
import "/vendor/.vite-deps-chunk-BTIRXD3D.js__v--d8a63f7e.js";
import "/vendor/.vite-deps-chunk-HO635D32.js__v--d8a63f7e.js";
import {
  __export,
  __privateAdd,
  __privateGet,
...
var _Signature = class {
  ...
  static from(sig) {
    ...
    if (typeof sig === "string") {
      ...
      if (bytes.length === 64) {
        const r3 = hexlify(bytes.slice(0, 32));
...
var _ParamType = class {
  ...
  async walkAsync(value, process3) {
    const promises = [];
    const result = [value];
    __privateMethod(this, _walkAsync, walkAsync_fn).call(this, promises, value, process3, (value2) => {
      result[0] = value2;
    });
    if (promises.length) {
...
walkAsync_fn = function(promises, value, process3, setValue) {
  if (this.isArray()) {
    if (!Array.isArray(value)) {
      throw new Error("invalid array value");
    }
    ...
    result2.forEach((value2, index) => {
      var _a2;
      __privateMethod(_a2 = childType, _walkAsync, walkAsync_fn).call(_a2, promises, value2, process3, (value3) => {
  ...
  if (this.isTuple()) {
    ...
    result2.forEach((value2, index) => {
      var _a2;
      __privateMethod(_a2 = components[index], _walkAsync, walkAsync_fn).call(_a2, promises, value2, process3, (value3) => {
        result2[index] = value3;
      });
    });
    setValue(result2);
  ...
  __privateSet(this, _drainTimer, setTimeout(() => {
    ...
    while (payloads.length) {
      ...
      while (payloads.length) {
        ...
        if (bytes.length > __privateGet(this, _options2).batchMaxSize) {
